...
class User2 {
    constructor() {
        this.x = 10; // private이면 해당 class에서만 사용가능하다.
...
User3.x = 10; // static은 부모만 쓸수 있게 한다. --> 자식들은 상속받지 못한다.
let 자식2 = new User3();
User3.x; // 이렇게 해야 x = 10값을 쓸 수 있다.
class User4 {
    constructor() {
        this.intro = User4.skill + "안녕";
    }
}
User4.skill = "JS";
User4.skill = "TS";
...
class User5 {
    constructor() {
        this.z = 30; // 해당User5 및 extends된 class에서만 쓰일 수 있다.
    }
}
User5.x = 10; // 해당 User5내에서만 쓰이고 자식에게 상속이 안된다.
User5.y = 20; // 자식에게 상속이 안된다.
class User6 {
    constructor() {
        this.addOne = (a) => {
            return User6.x + a;

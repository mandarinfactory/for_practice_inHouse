...
export default function NotUpdatedInfos({ setNotUpdatedInfos }) {
  ...
  return (
    <div
      className="flex flex-col justify-center items-center absolute top-[20%] w-[35%] h-[30%] bg-white shadow-lg rounded-xl animate-fade animate-duration-200 cursor-pointer"
      onClick={() => {
        setNotUpdatedInfos(false)
        MovieInfosCtx.setIsBoxClicked(false)
      }}
    >
      <h1 className="text-3xl font-bold md:text-2xl sm:text-sm">

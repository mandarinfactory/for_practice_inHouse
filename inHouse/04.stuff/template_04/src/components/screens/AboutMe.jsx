    ...
    <section className="flex min-h-screen flex-col items-center justify-center text-gray-600 body-font dark:bg-slate-800 dark:text-gray-300">
      <div className="container lg:w-[70%] md:w-full sm:w-full mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="mt-4">
            <h1 className="my-5 text-2xl">연락처</h1>
            <div className="w-full h-auto flex">
              <a href="" title="휴대전화">
                <svg
                  ...
                  height="3em"
                  viewBox="0 0 384 512"
                  className="mr-10 fill-gray-700 hover:fill-black cursor-pointer duration-100"
                >
              ...
              <a href="" title="이력서">
                <svg
                  ...
                  height="3em"
                  viewBox="0 0 384 512"
                  className="fill-gray-700 hover:fill-black cursor-pointer duration-100"
                >

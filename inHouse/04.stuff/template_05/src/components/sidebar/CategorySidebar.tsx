  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        <h1 className="md:hidden sm:hidden">인기 급상승</h1>
      </div>
      <div
        className="flex flex-col justify-center items-center mb-7 hover:text-sky-800 dark:hover:text-sky-400 cursor-pointer"
        onClick={() => {
      ...
      >
        ...
        <h1 className="md:hidden sm:hidden">음악</h1>
      </div>
      <div
        className="flex flex-col justify-center items-center mb-7 hover:text-sky-800 dark:hover:text-sky-400 cursor-pointer"
        onClick={() => {
      ...
      >
        ...
        <h1 className="md:hidden sm:hidden">영화</h1>
      </div>
      <div
        className="flex flex-col justify-center items-center mb-7 hover:text-sky-800 dark:hover:text-sky-400 cursor-pointer"
        onClick={() => {
      ...
      >
        ...
        <h1 className="md:hidden sm:hidden">실시간 방송</h1>
      </div>
    </div>
  );
};

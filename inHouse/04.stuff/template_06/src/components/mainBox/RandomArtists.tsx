    ...
    <>
      ...
      <div className="flex flex-wrap">
        {randomArtistsData?.artists.items.map((e: any, i: number) => (
          <div className="m-3 flex justify-center items-center w-[18%]" key={i}>
            <div className="relative w-[80%] hover:scale-95 duration-150 cursor-pointer">
              <img
                ...
                alt="아티스트"
              />
              <h1 className="absolute top-1 right-2 text-white mix-blend-difference mt-2 drop-shadow-2xl uppercase text-xl">
                {e.name}
              </h1>
            </div>
          </div>

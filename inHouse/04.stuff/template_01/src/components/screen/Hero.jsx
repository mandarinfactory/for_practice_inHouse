  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center">
      <div className="lg:w-[50%] sm:w-[90%] sm:ml-10 h-full flex justify-start">
        <button
          className="mr-10 mt-7 lg:text-3xl md:text-3xl sm:text-2xl drop-shadow-lg hover:text-slate-700"
          onClick={() => {
            setIsBoxOffice(true);
            setIsUpcoming(false);
          }}
        ...
        <button
          className="mt-7 lg:text-3xl md:text-3xl sm:text-2xl drop-shadow-lg hover:text-slate-700"
          onClick={() => {
      ...
      <input
        className="lg:w-[50%] md:w-[50%] sm:w-[90%] p-5 my-1 opacity-40 rounded-lg md:text-2xl sm:text-xl shadow-xl"
        type="text"

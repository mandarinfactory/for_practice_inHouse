...
export default function MovieTrailerBox() {
  ...
  return (
    <div className="absolute w-full h-full flex justify-center items-center bg-black z-20 bg-opacity-80">
      <button>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          height="3em"
          viewBox="0 0 384 512"
          className="absolute top-10 right-10 fill-white"
      ...
      <div className="relative w-[50%] h-[50%]">
        <iframe
          src={movieTrailer}
          className="absolute top-0 left-0 w-full h-full z-30 overflow-x-hidden overflow-y-hidden"
        />
      </div>
    </div>
  );

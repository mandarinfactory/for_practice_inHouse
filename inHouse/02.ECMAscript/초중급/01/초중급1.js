...
Object.freeze(사람이름); // 이렇게 freeze로 묶으면 수정이 불가능해진다. error가 따로 출력되지는 않는다.
...
// 단, let,const로 변수선언시 hoisting이 일어나도 undefined를 출력시키지 않는다. (var만 undefined 출력함.) --> 이걸 temporal deadzone / uninitalized라고 한다.
